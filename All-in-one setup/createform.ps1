...
Teams - Remove Team
'@
Invoke-HelloIDDelegatedForm -DelegatedFormName $delegatedFormName -DynamicFormGuid $dynamicFormGuid -AccessGroups $delegatedFormAccessGroupGuids -Categories $delegatedFormCategoryGuids -UseFaIcon "True" -FaIcon "fa fa-minus-square" -returnObject ([Ref]$delegatedFormRef) 
<# End: Delegated Form #>
...
'@; 
	...
	$tmpVariables = @'
{"name":"groupId","value":"{{form.teams.GroupId}}","secret":false,"typeConstraint":"string"}
'@ 
